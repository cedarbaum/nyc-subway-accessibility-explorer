...
export const ElevatorAndEscalatorAvailabilitySchema = z.object({
  ...
  am_peak_hours_available: z.string().transform(parseFloatFromString),
  am_peak_total_hours: z.string().transform(parseFloatFromString),
  pm_peak_availability: z.string().transform(parseFloatFromString),
  pm_peak_hours_available: z.string().transform(parseFloatFromString),
  pm_peak_total_hours: z.string().transform(parseFloatFromString),
  _24_hour_availability: z.string().transform(parseFloatFromString),
  _24_hour_hours_available: z.string().transform(parseFloatFromString),
  _24_hour_total_hours: z.string().transform(parseFloatFromString),
